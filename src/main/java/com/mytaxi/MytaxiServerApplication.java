...
import com.mytaxi.utils.LoggingInterceptor;
...
@Profile("!test")
public class MytaxiServerApplication implements WebMvcConfigurer {

    public static void main(String[] args) {
        SpringApplication.run(MytaxiServerApplication.class, args);
    }

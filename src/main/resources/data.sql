...
INSERT INTO manufacturer(ID, DATE_CREATED, NAME, DELETED) VALUES(1,  now(), 'Nissan', false);

INSERT INTO car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED, IS_DRIVER_ASSIGNED)
VALUES(1, true, now(),  'ELECTRIC', 'PLATE1', 4.0, 3, 1, false, false);

INSERT INTO car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED, IS_DRIVER_ASSIGNED)
VALUES(2, true, now(),  'GAS', 'PLATE2', 3.5, 4, 1, false, false);

INSERT INTO car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED, IS_DRIVER_ASSIGNED)
VALUES(3, false, now(),  'ELECTRIC', 'PLATE3', 4.0, 6, 1,false, false);